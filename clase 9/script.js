const VOCABULARY = [
    ...
    { word: 'studio suite', meaning: 'monoambiente', category: 'default' },
    { word: 'submit a report', meaning: 'entregar un informe', category: 'default' },
    { word: 'available', meaning: 'disponible', category: 'default' },
    { word: 'handheld', meaning: 'portátil', category: 'default' },
    { word: 'handheld sound level meter', meaning: 'sonómetro portátil' }
];
