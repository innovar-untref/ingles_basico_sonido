const VOCABULARY = [
    { word: 'background', meaning: 'de fondo', category: 'default' },
    ...
    { word: 'several', meaning: 'varios', category: 'default' },
    { word: 'therefore', meaning: 'por lo tanto', category: 'default' },
    { word: 'most', meaning: 'mayoría', category: 'default' },
    { word: 'even', meaning: 'aún', category: 'default' },
    { word: 'while', meaning: 'mientras', category: 'default' },
    { word: 'shooting range', meaning: 'polígono de tiro' }
];
