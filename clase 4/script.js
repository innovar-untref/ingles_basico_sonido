const VOCABULARY = [
    ...
    { word: 'turn on', meaning: 'encender', category: 'default' },
    { word: 'takes place', meaning: 'tiene lugar', category: 'default' },
    { word: 'done', meaning: 'hecho', category: 'default' },
    { word: 'builders', meaning: 'constructores', category: 'default' },
    { word: 'shape', meaning: 'forma', category: 'default' },
    { word: 'how', meaning: 'cómo', category: 'default' },
    { word: 'together', meaning: 'juntos', category: 'default' },
    { word: 'because of this', meaning: 'por esta causa', category: 'default' },
    { word: 'is built', meaning: 'es construido', category: 'default' },
    { word: 'teamwork', meaning: 'trabajo en equipo', category: 'default' }
];
