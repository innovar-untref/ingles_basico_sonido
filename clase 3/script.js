const VOCABULARY = [
    ...
    { word: 'polished', meaning: 'lustroso', category: 'default' },
    { word: 'ensuring', meaning: 'asegurando', category: 'default' },
    { word: 'soundscapes', meaning: 'paisaje sonoro', category: 'default' },
    { word: 'research', meaning: 'investigación', category: 'default' },
    { word: 'coding', meaning: 'codificación', category: 'default' }
];
