const VOCABULARY = [
    { word: 'spoken', meaning: 'hablado/a', category: 'default' },
    { word: 'explanations', meaning: 'explicaciones', category: 'default' },
    { word: 'physicists', meaning: 'físicos', category: 'default' },
    { word: 'content', meaning: 'contenido', category: 'default' },
    { word: 'deals with', meaning: 'trata de', category: 'default' },
    { word: 'while', meaning: 'mientras que', category: 'default' },
    { word: 'ducts', meaning: 'conductos', category: 'default' },
    { word: 'so as to', meaning: 'para que', category: 'default' },
    { word: 'assessment', meaning: 'evaluación', category: 'default' },
    { word: 'since', meaning: 'puesto que', category: 'default' },
    { word: 'damage', meaning: 'daño' }
];
